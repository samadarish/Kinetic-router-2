...
# Archived implementation brief

This document predates the unified kineticRouter monorepo and is retained only for historical context. Current paths, commands, and architecture are documented in the root `README.md`.
