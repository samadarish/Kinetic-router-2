...
if [ -f "$CONFIG_FILE" ]; then
  printf '%s\n' "Codex config already exists at $CONFIG_FILE. Add the Kinetic Router provider from https://kineticrouter.com/docs/integrations/codex/websocket"
  exit 0
fi
...
printf '%s\n' "Configured Kinetic Router for Codex at $CONFIG_FILE"
