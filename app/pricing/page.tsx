...
export default function PricingPage() {
  ...
  return <SiteFrame>
    <section className="px-4 pb-12 pt-16 text-center md:pb-16 md:pt-24">
      ...
      <h1 className="mx-auto mt-4 max-w-4xl text-4xl font-semibold leading-[1.1] tracking-[-.045em] md:text-[3.5rem]">The exact Hao.ai catalog,<br className="hidden sm:block" /> with honest route status</h1>
      <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-muted-foreground">These model names and price values are preserved from the Hao.ai snapshot captured on {catalogSnapshot.capturedAt}. They are not a live Kinetic Router billing feed; your customer portal remains authoritative.</p>
