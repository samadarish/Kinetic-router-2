...
const page = getPageMeta('/quickstart');
const openAiStatus = providerDisplayStatus('openai');
export const metadata: Metadata = { title: page?.title ?? 'API Quickstart', description: `Configure the kineticRouter ${openAiStatus.protocolLabel} route. ${openAiStatus.summary}` };
