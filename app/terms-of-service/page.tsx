...
const sections = [
  ...
  { title: '8. Intellectual Property', paragraphs: ['The Services, website, branding, software, and documentation are owned by kineticRouter or its licensors. These Terms provide a limited right to use the Services and do not transfer ownership.'] },
  ...
  { title: '11. Disclaimers and Limitation of Liability', paragraphs: ['The Services are provided “as is” and “as available.” To the maximum extent permitted by law, kineticRouter disclaims implied warranties and is not liable for indirect, incidental, special, consequential, or lost-profit damages.'] },
  { title: '12. Indemnity', paragraphs: ['You agree to defend and indemnify kineticRouter against claims arising from your Content, misuse of the Services, or violation of these Terms or applicable law.'] },
