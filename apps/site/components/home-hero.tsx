    ...
    <section className="overflow-hidden">
      ...
      <div className="relative overflow-hidden pb-10 pt-4 md:pb-16 md:pt-5">
        ...
        <div className="mx-auto mt-7 grid max-w-3xl grid-cols-2 gap-2 sm:gap-3">
          <div><strong className="block text-[17px] font-semibold tracking-tight sm:text-2xl">20 models</strong><span className="text-xs leading-tight text-muted-foreground sm:text-xs">Dated catalog<br className="sm:hidden" /> snapshot</span></div>
